    ...
    <footer className="border-t border-border/50 py-12">
      <div className="container">
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              ...
              <a href="mailto:info@vykupon.by" className="flex items-center gap-2 hover:text-primary transition-colors">
                <Mail className="w-4 h-4" /> info@vykupon.by
              </a>
        ...
        <div className="mt-12 pt-6 border-t border-border/50 text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} VykupON (vykupon.by). Все права защищены.
        </div>
      </div>
    </footer>
  );
